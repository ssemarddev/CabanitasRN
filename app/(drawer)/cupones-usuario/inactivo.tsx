...
const inactivo = () => {
  return (
    ...
    >
      <Text className="text-4xl font-extrabold">Cupones</Text>
      ...
      {/* Tarjeta del cupón */}
      <View className="relative bg-white rounded-2xl shadow-lg p-6 mt-20">
        <View className="flex-row justify-between items-center w-full">
          ...
          <View className="w-40">
            <View className="flex-row items-center">
              <MaterialCommunityIcons name="cake-variant" size={24} color="black" />
        ...
        <Text className="text-lg font-bold mt-6 text-center">Obtén un buffet de cortesía</Text>
        <View className="pb-9 px-14">
          <Text className="text-gray-700">• Cupón válido para 1 persona, solo cumpleañero.</Text>
          <Text className="mt-4 text-gray-700">• No válido con ninguna otra promoción o descuento.</Text>
        ...
        <Text className="text-center text-xl font-bold mt-1 text-gray-500">
          No disponible aún
        </Text>
        ...
        <View className="absolute inset-0 bg-black/60 rounded-2xl flex justify-center items-center">
          <Text className="text-white text-2xl font-extrabold transform rotate-12">
            CUPÓN NO DISPONIBLE
          </Text>
        </View>
      </View>
